var pantalla = document.querySelector("#ahorcado"); //recibira al canvas de html
...
function dAhorcado(paso) {
    ...
    switch (paso) {
        ...
        pincel.beginPath();
        pincel.arc(275, 240, 40,0,Math.PI * 4);
        pincel.fill();
        pincel.beginPath();
            pincel.fillStyle = "white";
            //ojo izquierdo
        ...
        case 11:
                ...
                pincel.fillText("GANASTE, FELICIDADES!!!", 450, 200);
                console.log("GANASTE");
                break;    
    }
